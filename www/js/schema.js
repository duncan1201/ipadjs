app.constant('Schema_SQLs',
             [
              ...
              /* products table */
              'Create table if not exists products(id integer primary key, product_name varchar(100), product_handle varchar(100), desc varchar(255), creation_date datetime, brand_id integer, supplier_id integer, supply_price real, markup real, foreign key (brand_id) references Brands(id), foreign key (supplier_id) references Suppliers(id))',
